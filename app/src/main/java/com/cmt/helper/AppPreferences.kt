...
class AppPreferences {
    ...
    /*fun deleteUserId(context: Context): String {
    ...
    fun setAccessToken(context: Context, access_token: String) {
        val preferences =
            context.getSharedPreferences(IConstants.Pref.shared_preference, Context.MODE_PRIVATE)
                .edit()
        preferences.putString(IConstants.Pref.token, access_token)
        preferences.apply()
    }
    ...
    fun getAccessToken(context: Context): String? {
        val preferences =
            context.getSharedPreferences(IConstants.Pref.shared_preference, Context.MODE_PRIVATE)
        return if (preferences.contains(IConstants.Pref.token)) {
            preferences.getString(IConstants.Pref.token, null)
        } else {
            null
        }
    }
    ...
    fun signOut(context: Context, userId: String) {
        val preferences =
            context.getSharedPreferences(IConstants.Pref.shared_preference, Context.MODE_PRIVATE)
                .edit()
        preferences.clear()
    ...
    fun logout(context: Context) {
        val preferences = context.getSharedPreferences(IConstants.Pref.shared_preference,Context.MODE_PRIVATE).edit()
        preferences.remove(IConstants.Pref.user_id)
        preferences.remove(IConstants.Pref.token)
        preferences.apply()
    }
}