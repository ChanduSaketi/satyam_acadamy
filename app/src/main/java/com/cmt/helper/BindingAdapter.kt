...
fun loadImage(
    ...
    if (imageUrl != null && imageUrl.isNotEmpty()) {
        Glide.with(view).load(imageUrl).placeholder(circularProgressDrawable).into(view)
    } else if (bitmapImage != null) {
        Glide.with(view).load(bitmapImage).placeholder(circularProgressDrawable).into(view)
    } else if (drawableImage != null) {
        Glide.with(view).load(drawableImage).placeholder(circularProgressDrawable).into(view)
